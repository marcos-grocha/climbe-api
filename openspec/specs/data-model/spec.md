...
Camada de dados do domínio Climbe: as 15 entidades do diagrama ER persistidas como
models SQLAlchemy 2.x, com integridade referencial (FKs e `ondelete` explícitos),
unicidade de identificadores de negócio, timestamps de auditoria e seeds das tabelas
de referência (cargos e serviços).
...
- THEN the 8 formal Climbe roles are present

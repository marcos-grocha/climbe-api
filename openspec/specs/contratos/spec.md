...
Contratos gerados automaticamente quando uma proposta é aprovada, com prazo de entrega
variável, flag de recorrência (CFO/BPO) e ciclo `ativo → encerrado`. Ligam o comercial
(proposta) à execução (documentos, planilhas, relatórios).

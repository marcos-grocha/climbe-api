...
Camada de persistência: conexão PostgreSQL via SQLAlchemy 2.x, dependency de
sessão por request, base declarativa para os models, Alembic para migrations e
health check de readiness do banco.
